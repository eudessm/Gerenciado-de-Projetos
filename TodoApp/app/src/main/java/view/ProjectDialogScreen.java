...
public class ProjectDialogScreen extends javax.swing.JDialog {
    ...
    //Reutilizar o controlador já existente
    ProjectContoller controller;
            
    public ProjectDialogScreen(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        controller = new ProjectContoller();
    }
    ...
    private void jLabelToolBarSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelToolBarSaveMouseClicked
        ...
        //pegar o texto que está dentro do componete por isso utilizamos o ".getText"
        project.setName(jTextFieldName.getText());
        project.setDiscription(jTextAreaDescription.getText());
        //Mandar o controlador salvar 
